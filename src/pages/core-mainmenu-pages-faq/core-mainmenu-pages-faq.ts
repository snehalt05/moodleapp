...
export class CoreMainmenuPagesFaqPage implements OnInit{
  ...
  faqData=[
    {id:0,question:'Is there any eligibility criteria for this data science program?',answers:'The learner must have the HSC Certificate (Standard 12th in India) or equivalent. No  pre-requisites or experience is required. The course covers every detail required to acquire  the fundamental skill set to start a data science career path.'},
  {id:1,question:'Do I need a computer system (desktop/laptop) for this program? If so, what are the system specifications?',
  ...
  id:2,question:'What languages does Rubiversity support?',answers:'In the present version, Rubiversity LMS offers courses in English.'
},{
  id:3,question:'Do I have to start my course at a certain time?',answers:'The course is self-paced course.  It can be started at any time. The course should be completed within 2 months (60 calendar days) of starting the course.'
},{
  id:4,question:'What can I expect to get when I complete the course?',answers:'You will receive a certificate of completion which will serve as a pre-requisite for other   courses. You can explore a wide range of courses in the data science field as per your career  path and persona.'
},{
  id:5,question:'What courses does rubiVersity offer?',answers:' rubiVersity offers courses in the field of data science. The courses are uniquely  designed, industry and future-ready, learning paths that evolve into modular courses from  Foundational level to Masters level, delivering a unique learning experience. We are always building new courses to ensure that our users can learn the best technology  in market in a fully elaborated course.'
}
